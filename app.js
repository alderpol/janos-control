...
function zohoAccountsPanelBody(){
  ...
  return `<p class="muted">El botón "Enviar material" de la ficha del cliente manda el mail desde la casilla del salón del cliente. Si no cargás nada acá, se usa la cuenta general de ese salón. Necesitás una <strong>contraseña de aplicación</strong> de Zoho (no la contraseña normal de tu cuenta). Si trabajás en más de un salón, cargá una cuenta para cada uno.</p><details class="zoho-help"><summary>¿Cómo genero mi contraseña de aplicación de Zoho?</summary><ol><li>Entrá a <a href="https://accounts.zoho.com/home#security/app-passwords" target="_blank" rel="noopener noreferrer">accounts.zoho.com/home#security/app-passwords</a> con tu cuenta de Zoho.</li><li>Si te pide confirmar tu contraseña ("Confirme su identidad"), escribila y confirmá. Es un paso normal de seguridad de Zoho.</li><li>En "Contraseñas específicas de aplicación", hacé clic en "+ Generar nueva contraseña".</li><li>Escribí un nombre para identificarla, por ejemplo: Janos Control.</li><li><strong>Importante:</strong> Zoho te muestra la contraseña generada UNA SOLA VEZ. Copiala enseguida, antes de cerrar esa ventana — si la cerrás sin copiarla, tenés que generar una nueva.</li><li>Volvé acá y pegala en el campo "Contraseña de aplicación" del salón correspondiente, junto con tu email de Zoho.</li></ol></details>${mySalons.map(salon=>{
