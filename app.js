...
document.addEventListener("click", e => {
  ...
  if(e.target.id==="toggleRates"){const body=document.getElementById("ratesBody");const btn=document.getElementById("toggleRates");const hidden=body.classList.toggle("hidden");btn.setAttribute("aria-expanded",String(!hidden));btn.querySelector(".collapse-icon").textContent=hidden?"▼":"▲";}
