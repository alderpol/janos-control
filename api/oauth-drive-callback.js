...
export async function handler(event) {
  ...
  try {
        ...
        if (!clientId || !clientSecret) {
                return paginaHtml("Falta configuración", "Faltan GOOGLE_OAUTH_CLIENT_ID/GOOGLE_OAUTH_CLIENT_SECRET en Vercel.", false);
        }
      ...
      if (!process.env.SUPABASE_SERVICE_ROLE_KEY) {
              return paginaHtml("Falta configuración", "Falta SUPABASE_SERVICE_ROLE_KEY en Vercel.", false);
      }
